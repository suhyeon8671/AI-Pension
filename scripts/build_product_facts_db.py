...
def main():
    ...
    parser.add_argument("--product-master", default=os.path.join(REPO_ROOT, "structured", "product_master.json"))
    parser.add_argument("--class-fees", default=os.path.join(REPO_ROOT, "structured", "class_fees.json"))
    parser.add_argument("--class-returns", default=os.path.join(REPO_ROOT, "structured", "class_returns.json"))
    parser.add_argument("--manager-info", default=os.path.join(REPO_ROOT, "structured", "manager_info.json"))
    parser.add_argument("--fund-aum", default=os.path.join(REPO_ROOT, "structured", "fund_aum.json"))
    parser.add_argument("--class-meaning",
                        default=os.path.join(REPO_ROOT, "structured", "class_meaning.json"))
    parser.add_argument("--class-charges",
                        default=os.path.join(REPO_ROOT, "structured", "class_charges.json"))
    parser.add_argument("--yearly-returns",
                        default=os.path.join(REPO_ROOT, "structured", "yearly_returns.json"))
    parser.add_argument("--trade-rules",
                        default=os.path.join(REPO_ROOT, "structured", "trade_rules.json"))
    parser.add_argument("--product-charges",
                        default=os.path.join(REPO_ROOT, "structured", "product_charges.json"))
    parser.add_argument("--asset-mix",
                        default=os.path.join(REPO_ROOT, "structured", "asset_mix.json"))
